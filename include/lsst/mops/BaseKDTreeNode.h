...
namespace mops {
    ...
    public: 
         ...
         */
        BaseKDTreeNode(std::vector<PointAndValue <T> > pointsAndValues, 
         ...
         *
         *for a collection of points and values, find the median value along the
         * given axis and return it
         *
...
than dimensions of data\n");
   ...
   template <class T, class RecursiveT>
    ...
    /*we know that we have at least one element here, so we're fine (fastMedian
     * demands non-empty vector)*/
