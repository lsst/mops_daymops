...
int main(int argc, char* argv[])
{
    ...
    //std::vector<lsst::mops::Track> resultTracks;
    clock_t last;
    double dif;
    ...
    lsst::mops::populateDetVectorFromFile(detectionsFileName, allDets);
    lsst::mops::populatePairsVectorFromFile(trackletsFileName, allTracklets);
    ...
    if( rank == 0){
        ...
        lsst::mops::distributedLinkTracklets(allDets, allTracklets, searchConfig, /*rank,*/ numProcessors);
     ...
     *************************************************************/
        ...
        lsst::mops::waitForTask(rank, allDets, allTracklets, searchConfig);
    }
